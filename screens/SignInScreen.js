  ...
  return (
    <View style={[styles.body, { minHeight: Math.round(windowHeight), }]}>
      ...
      <View style={styles.remember}>
        {/* <Checkbox /> */}
        <Text style={{ fontWeight: "500", color: thirdColor }}>Recordar contraseña</Text>
      </View>

      <TouchableOpacity style={styles.button} activeOpacity={0.85}>
        <Text style={{ color: "white", textAlign: "center", fontWeight: "500" }}>Iniciar Sesión</Text>
      </TouchableOpacity>
      ...
      <View style={{ flexDirection: "row" }}>
        <Text style={{ color: "gray" }}>¿Aún no tienes una cuenta?</Text>
        <TouchableOpacity
